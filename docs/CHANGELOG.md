...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert.html): convert gauge vmalert_{alerting,recording}_rules_error to counter vmalert_{alerting,recording}_rules_error_total metrics, update dashboards and recommended alerting rules for vmalert. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5160). 
