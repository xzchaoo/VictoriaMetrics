...
* FEATURE: [vmalert](https://docs.victoriametrics.com/vmalert.html): expose counters `vmalert_{alerting,recording}_rules_error_total`, update panels in the grafana dashboards and recommended alerting rules for vmalert. Deprecate gauge `vmalert_{alerting,recording}_rules_error` and all panels in the grafana dasboards.   See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/5160).
